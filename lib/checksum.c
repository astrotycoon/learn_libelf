...
static const char rcsid[] =
    "@(#) $Id: checksum.c,v 1.7 2008/05/23 08:15:34 michael Exp $";
#endif				/* lint */
...
static int skip_section(Elf_Scn * scn, unsigned cls)
{
	if (cls == ELFCLASS32) {
...
static long add_bytes(unsigned char *ptr, size_t len)
{
	long csum = 0;
